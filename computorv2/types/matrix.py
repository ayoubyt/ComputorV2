...
class Matrix(Type):
    ...
    def __mul__(self, other):
        if (isinstance(other, Matrix)):
            ...
            raise ComputerV2Exception("multiplication only supported between matrices")
    ...
    def __add__(self, other):
        if (isinstance(other, Matrix)):
            ...
            raise ComputerV2Exception("addition only supported between matrices")
    ...
    def __sub__(self, other):
        if (isinstance(other, Matrix)):
            ...
            raise ComputerV2Exception("substraction only supported between matrices")
